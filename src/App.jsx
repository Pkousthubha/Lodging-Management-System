...
// Public pages
import PublicBookingPage from "./pages/public/PublicBooking.jsx";
import UserLoginPage from "./pages/public/UserLogin.jsx";
    ...
    <SessionTimeoutProvider>
      <>
        ...
        <Routes>
          ...
          <Route path="/public/login" element={<UserLoginPage />} />
          ...
          <Route path="*" element={<Navigate to="/public/booking" replace />} />
        </Routes>
